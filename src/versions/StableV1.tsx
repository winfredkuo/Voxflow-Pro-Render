  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-2xl mx-auto space-y-12">
      <header className="text-center space-y-4">
        ...
        <h1 className="text-4xl md:text-5xl font-black tracking-tight text-slate-900 dark:text-slate-50">AI 專業 <span className="text-indigo-600 dark:text-indigo-400">語音轉錄</span></h1>
        <p className="text-slate-500 dark:text-slate-400 text-lg">高精度 AI 引擎：專注於極速、精準的語音轉文字服務。</p>
      </header>
